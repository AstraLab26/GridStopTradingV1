//+------------------------------------------------------------------+
//|                      GridStopTradingV1.mq5                         |
//|         EA lưới chỉ dùng lệnh Stop (Buy Stop / Sell Stop), gồng lãi, cân bằng lệnh |
//+------------------------------------------------------------------+
...
input bool ShowPanel = true;                     // Hiển thị panel thông tin trên chart (chỉ bản có Panel)
...
#define PANEL_PREFIX "GSTV1_Panel_"
#define PANEL_BG    PANEL_PREFIX "BG"
#define PANEL_HEAD  PANEL_PREFIX "Head"
#define PANEL_TITLE PANEL_PREFIX "Title"
#define PANEL_STATUS PANEL_PREFIX "Status"
#define PANEL_GEAR  PANEL_PREFIX "Gear"
#define PANEL_BAL_BG  PANEL_PREFIX "BalBG"
#define PANEL_BAL_LBL PANEL_PREFIX "BalLbl"
#define PANEL_BAL_VAL PANEL_PREFIX "BalVal"
#define PANEL_BAL_SUB PANEL_PREFIX "BalSub"
#define PANEL_POS_TITLE PANEL_PREFIX "PosTitle"
#define PANEL_BUY_BG  PANEL_PREFIX "BuyBG"
#define PANEL_BUY_VAL PANEL_PREFIX "BuyVal"
#define PANEL_BUY_LBL PANEL_PREFIX "BuyLbl"
#define PANEL_SELL_BG PANEL_PREFIX "SellBG"
#define PANEL_SELL_VAL PANEL_PREFIX "SellVal"
#define PANEL_SELL_LBL PANEL_PREFIX "SellLbl"
#define PANEL_PEND_BG PANEL_PREFIX "PendBG"
#define PANEL_PEND_VAL PANEL_PREFIX "PendVal"
#define PANEL_PEND_LBL PANEL_PREFIX "PendLbl"
#define PANEL_TRAIL_LBL PANEL_PREFIX "TrailLbl"
#define PANEL_TRAIL_VAL PANEL_PREFIX "TrailVal"
#define PANEL_ACCUM_LBL PANEL_PREFIX "AccumLbl"
#define PANEL_ACCUM_VAL PANEL_PREFIX "AccumVal"
#define PANEL_PROFIT_A_LBL PANEL_PREFIX "ProfitALbl"
#define PANEL_PROFIT_A_VAL PANEL_PREFIX "ProfitAVal"
#define PANEL_PROFIT_B_LBL PANEL_PREFIX "ProfitBLbl"
#define PANEL_PROFIT_B_VAL PANEL_PREFIX "ProfitBVal"

//+------------------------------------------------------------------+
//| Tạo panel thông tin (bố cục giống hình: header, Gốc, Vị thế, Trạng thái) |
//+------------------------------------------------------------------+
void CreatePanel()
{
   int x = 14, y = 30;
   ...
   int headH = 40;
   int balH = 72;
   int cardW = 88, cardH = 56;
   int gap = 4;
   color bgColor = (color)C'28,32,42';
   color headColor = (color)C'40,52,70';
   color borderColor = (color)C'56,72,96';
   color titleColor = (color)C'255,255,255';
   color statusGreen = (color)C'100,220,140';
   color dimColor = (color)C'120,132,156';
   color balBgColor = (color)C'30,60,50';
   color textDim = (color)C'160,168,180';
   color cardBuyBg = (color)C'35,55,45';
   color cardSellBg = (color)C'55,35,40';
   color cardPendBg = (color)C'45,45,50';
   color cardText = (color)C'220,225,235';
   color cardBuyAccent = (color)C'100,220,140';
   color cardSellAccent = (color)C'255,100,100';
   color cardPendAccent = (color)C'160,168,180';
   ...
   ObjectSetInteger(0, PANEL_BG, OBJPROP_BGCOLOR, bgColor);
   ObjectSetInteger(0, PANEL_BG, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_BG, OBJPROP_BORDER_COLOR, borderColor);
   ObjectSetInteger(0, PANEL_BG, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BG, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_HEAD, OBJ_RECTANGLE_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_XDISTANCE, x + 1);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_YDISTANCE, y + 1);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_XSIZE, w - 2);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_YSIZE, headH);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_BGCOLOR, headColor);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_BORDER_COLOR, borderColor);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_HEAD, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_TITLE, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_TITLE, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_TITLE, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_TITLE, OBJPROP_YDISTANCE, y + 6);
   ObjectSetString(0, PANEL_TITLE, OBJPROP_TEXT, "Grid Stop V1");
   ObjectSetInteger(0, PANEL_TITLE, OBJPROP_COLOR, titleColor);
   ObjectSetInteger(0, PANEL_TITLE, OBJPROP_FONTSIZE, 12);
   ...
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_YDISTANCE, y + 22);
   ObjectSetString(0, PANEL_STATUS, OBJPROP_TEXT, "• DANG CHAY");
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_COLOR, statusGreen);
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_FONTSIZE, 9);
   ...
   ObjectCreate(0, PANEL_GEAR, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_XDISTANCE, x + w - 28);
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_YDISTANCE, y + 10);
   ObjectSetString(0, PANEL_GEAR, OBJPROP_TEXT, "[...]");
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_COLOR, dimColor);
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_GEAR, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_GEAR, OBJPROP_SELECTABLE, false);
   
   int balY = y + headH + gap;
   ObjectCreate(0, PANEL_BAL_BG, OBJ_RECTANGLE_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_XDISTANCE, x + 8);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_YDISTANCE, balY);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_XSIZE, w - 16);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_YSIZE, balH);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_BGCOLOR, balBgColor);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_BORDER_COLOR, (color)C'50,90,70');
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BAL_BG, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_BAL_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_XDISTANCE, x + 16);
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_YDISTANCE, balY + 6);
   ObjectSetString(0, PANEL_BAL_LBL, OBJPROP_TEXT, "GOC (DUONG GOC)");
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_COLOR, textDim);
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_BAL_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BAL_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_BAL_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_XDISTANCE, x + 16);
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_YDISTANCE, balY + 24);
   ObjectSetString(0, PANEL_BAL_VAL, OBJPROP_TEXT, "0.00");
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_COLOR, (color)C'255,255,255');
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_FONTSIZE, 16);
   ObjectSetString(0, PANEL_BAL_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BAL_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_BAL_SUB, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_XDISTANCE, x + 16);
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_YDISTANCE, balY + 52);
   ObjectSetString(0, PANEL_BAL_SUB, OBJPROP_TEXT, "Gia - Real-time");
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_COLOR, textDim);
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_FONTSIZE, 8);
   ObjectSetString(0, PANEL_BAL_SUB, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BAL_SUB, OBJPROP_SELECTABLE, false);
   
   int posY = balY + balH + 10;
   ObjectCreate(0, PANEL_POS_TITLE, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_YDISTANCE, posY);
   ObjectSetString(0, PANEL_POS_TITLE, OBJPROP_TEXT, "VI THE HIEN TAI");
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_COLOR, textDim);
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_POS_TITLE, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_POS_TITLE, OBJPROP_SELECTABLE, false);
   
   int cardY = posY + 18;
   int cardX1 = x + 10;
   int cardX2 = cardX1 + cardW + 4;
   int cardX3 = cardX2 + cardW + 4;
   
   ObjectCreate(0, PANEL_BUY_BG, OBJ_RECTANGLE_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_XDISTANCE, cardX1);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_YDISTANCE, cardY);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_XSIZE, cardW);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_YSIZE, cardH);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_BGCOLOR, cardBuyBg);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_BORDER_COLOR, (color)C'60,100,80');
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BUY_BG, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_BUY_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_XDISTANCE, cardX1 + 8);
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_YDISTANCE, cardY + 8);
   ObjectSetString(0, PANEL_BUY_VAL, OBJPROP_TEXT, "0");
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_FONTSIZE, 14);
   ObjectSetString(0, PANEL_BUY_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BUY_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_BUY_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_XDISTANCE, cardX1 + 8);
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_YDISTANCE, cardY + 34);
   ObjectSetString(0, PANEL_BUY_LBL, OBJPROP_TEXT, "BUY");
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_COLOR, cardBuyAccent);
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_BUY_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_BUY_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_SELL_BG, OBJ_RECTANGLE_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_XDISTANCE, cardX2);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_YDISTANCE, cardY);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_XSIZE, cardW);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_YSIZE, cardH);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_BGCOLOR, cardSellBg);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_BORDER_COLOR, (color)C'100,60,70');
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_SELL_BG, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_SELL_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_XDISTANCE, cardX2 + 8);
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_YDISTANCE, cardY + 8);
   ObjectSetString(0, PANEL_SELL_VAL, OBJPROP_TEXT, "0");
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_FONTSIZE, 14);
   ObjectSetString(0, PANEL_SELL_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_SELL_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_SELL_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_XDISTANCE, cardX2 + 8);
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_YDISTANCE, cardY + 34);
   ObjectSetString(0, PANEL_SELL_LBL, OBJPROP_TEXT, "SELL");
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_COLOR, cardSellAccent);
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_SELL_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_SELL_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PEND_BG, OBJ_RECTANGLE_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_XDISTANCE, cardX3);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_YDISTANCE, cardY);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_XSIZE, cardW);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_YSIZE, cardH);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_BGCOLOR, cardPendBg);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_BORDER_TYPE, BORDER_FLAT);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_BORDER_COLOR, (color)C'70,70,80');
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PEND_BG, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PEND_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_XDISTANCE, cardX3 + 8);
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_YDISTANCE, cardY + 8);
   ObjectSetString(0, PANEL_PEND_VAL, OBJPROP_TEXT, "0");
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_FONTSIZE, 14);
   ObjectSetString(0, PANEL_PEND_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PEND_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PEND_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_XDISTANCE, cardX3 + 8);
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_YDISTANCE, cardY + 34);
   ObjectSetString(0, PANEL_PEND_LBL, OBJPROP_TEXT, "CHO");
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_COLOR, cardPendAccent);
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_PEND_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PEND_LBL, OBJPROP_SELECTABLE, false);
   
   int footY = cardY + cardH + 12;
   ObjectCreate(0, PANEL_TRAIL_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_YDISTANCE, footY);
   ObjectSetString(0, PANEL_TRAIL_LBL, OBJPROP_TEXT, "Gong lai (Trailing)");
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_TRAIL_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_TRAIL_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_TRAIL_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_XDISTANCE, x + w - 95);
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_YDISTANCE, footY);
   ObjectSetString(0, PANEL_TRAIL_VAL, OBJPROP_TEXT, "OFF");
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_COLOR, dimColor);
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_TRAIL_VAL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_ACCUM_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_YDISTANCE, footY + 20);
   ObjectSetString(0, PANEL_ACCUM_LBL, OBJPROP_TEXT, "USD tich luy");
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_ACCUM_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_ACCUM_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_ACCUM_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_XDISTANCE, x + w - 95);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_YDISTANCE, footY + 20);
   ObjectSetString(0, PANEL_ACCUM_VAL, OBJPROP_TEXT, "0.00");
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_COLOR, statusGreen);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_ACCUM_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PROFIT_A_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_YDISTANCE, footY + 40);
   ObjectSetString(0, PANEL_PROFIT_A_LBL, OBJPROP_TEXT, "Lai/Lo Stop A");
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_PROFIT_A_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PROFIT_A_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PROFIT_A_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_XDISTANCE, x + w - 95);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_YDISTANCE, footY + 40);
   ObjectSetString(0, PANEL_PROFIT_A_VAL, OBJPROP_TEXT, "0.00");
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_COLOR, statusGreen);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_PROFIT_A_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PROFIT_B_LBL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_XDISTANCE, x + 12);
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_YDISTANCE, footY + 60);
   ObjectSetString(0, PANEL_PROFIT_B_LBL, OBJPROP_TEXT, "Lai/Lo Stop B");
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_COLOR, cardText);
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_PROFIT_B_LBL, OBJPROP_FONT, "Arial");
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PROFIT_B_LBL, OBJPROP_SELECTABLE, false);
   
   ObjectCreate(0, PANEL_PROFIT_B_VAL, OBJ_LABEL, 0, 0, 0);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_CORNER, CORNER_LEFT_UPPER);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_XDISTANCE, x + w - 95);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_YDISTANCE, footY + 60);
   ObjectSetString(0, PANEL_PROFIT_B_VAL, OBJPROP_TEXT, "0.00");
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_COLOR, statusGreen);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_FONTSIZE, 9);
   ObjectSetString(0, PANEL_PROFIT_B_VAL, OBJPROP_FONT, "Arial Bold");
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_BACK, false);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_SELECTABLE, false);
   ChartRedraw(0);
}

//+------------------------------------------------------------------+
//| Format số tiền ngắn gọn: 1000→1.00K, 1tr→1.00M (2 số thập phân)   |
//+------------------------------------------------------------------+
string FormatMoneyShort(double value)
{
   ...
   string sign = (value >= 0 ? "+" : "-");
   if(absVal >= 1000000.0)
      return sign + DoubleToString(absVal / 1000000.0, 2) + "M USD";
   if(absVal >= 1000.0)
      return sign + DoubleToString(absVal / 1000.0, 2) + "K USD";
   return sign + DoubleToString(absVal, 2) + " USD";
}
...
void UpdatePanel()
{
   ...
   double buyPr = 0, sellPr = 0, openPr = 0;
   GetPositionStats(buyCnt, sellCnt, buyPr, sellPr, openPr);
   int pendingCnt = 0;
   for(int i = 0; i < OrdersTotal(); i++)
   {
      ulong t = OrderGetTicket(i);
      if(t > 0 && OrderGetInteger(ORDER_MAGIC) == MagicNumber && OrderGetString(ORDER_SYMBOL) == _Symbol)
         pendingCnt++;
   }
   color clrStatusRun = (color)C'100,220,140';
   color clrStatusStop = (color)C'255,100,100';
   color clrStatusOutside = (color)C'255,180,100';
   color clrTrailOn = (color)C'100,220,140';
   color clrTrailOff = (color)C'120,132,156';
   
   string statusTxt = eaStopped ? "• DUNG" : (eaStoppedByTradingHours ? "• NGOAI GIO" : "• DANG CHAY");
   color statusClr = eaStopped ? clrStatusStop : (eaStoppedByTradingHours ? clrStatusOutside : clrStatusRun);
   ObjectSetString(0, PANEL_STATUS, OBJPROP_TEXT, statusTxt);
   ObjectSetInteger(0, PANEL_STATUS, OBJPROP_COLOR, statusClr);
   
   ObjectSetString(0, PANEL_BAL_VAL, OBJPROP_TEXT, DoubleToString(basePrice, dgt));
   ObjectSetString(0, PANEL_BUY_VAL, OBJPROP_TEXT, IntegerToString(buyCnt));
   ObjectSetString(0, PANEL_SELL_VAL, OBJPROP_TEXT, IntegerToString(sellCnt));
   ObjectSetString(0, PANEL_PEND_VAL, OBJPROP_TEXT, IntegerToString(pendingCnt));
   
   ObjectSetString(0, PANEL_TRAIL_VAL, OBJPROP_TEXT, isTradingStopActive ? "ON" : "OFF");
   ObjectSetInteger(0, PANEL_TRAIL_VAL, OBJPROP_COLOR, isTradingStopActive ? clrTrailOn : clrTrailOff);
   
   string accumTxt = FormatMoneyShort(accumulatedProfit);
   color accumClr = (accumulatedProfit >= 0 ? (color)C'100,220,140' : (color)C'255,100,100');
   ObjectSetString(0, PANEL_ACCUM_VAL, OBJPROP_TEXT, accumTxt);
   ObjectSetInteger(0, PANEL_ACCUM_VAL, OBJPROP_COLOR, accumClr);
   
   string profitATxt = FormatMoneyShort(profitStopASinceReset);
   color profitAClr = (profitStopASinceReset >= 0 ? (color)C'100,220,140' : (color)C'255,100,100');
   ObjectSetString(0, PANEL_PROFIT_A_VAL, OBJPROP_TEXT, profitATxt);
   ObjectSetInteger(0, PANEL_PROFIT_A_VAL, OBJPROP_COLOR, profitAClr);
   
   string profitBTxt = FormatMoneyShort(profitStopBSinceReset);
   color profitBClr = (profitStopBSinceReset >= 0 ? (color)C'100,220,140' : (color)C'255,100,100');
   ObjectSetString(0, PANEL_PROFIT_B_VAL, OBJPROP_TEXT, profitBTxt);
   ObjectSetInteger(0, PANEL_PROFIT_B_VAL, OBJPROP_COLOR, profitBClr);
   ChartRedraw(0);
}

//+------------------------------------------------------------------+
//| Xóa tất cả đối tượng panel                                        |
//+------------------------------------------------------------------+
void DeletePanel()
{
...
int OnInit()
{
   ...
   Print("========================================");
   Print("Grid Stop Trading EA V1 đã khởi động");
...
{
   DeletePanel();
   Print("Grid Stop Trading EA V1 đã dừng. Reason: ", reason);
}
...
void OnTick()
{
   static int panelUpdateTick = 0;
   panelUpdateTick++;
   if(ShowPanel && (panelUpdateTick % 15 == 0))
      UpdatePanel();
